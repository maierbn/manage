...
LIST(APPEND COMPONENT_COMMON_DEFS
    ...
    -DUSE_TAU_PROFILING=${USE_TAU_PROFILING}
    -DUSE_CUSTOM_PROFILING=${USE_CUSTOM_PROFILING}
    -DCMAKE_INSTALL_DEFAULT_COMPONENT_NAME=Development
    -DCMAKE_Fortran_COMPILER=ftn # added manually
)
...
message(STATUS "In OCCollectComponentDefinitions, COMPONENT_COMMON_DEFS=${COMPONENT_COMMON_DEFS}")
