...
# bzip2
if(FALSE AND OC_USE_BZIP2 OR OC_USE_ZINC OR OC_DEPENDENCIES_ONLY)
...
if(FALSE)
	...
	message(WARNING "after find_package(FIELDML-API... FIELDML-API_FOUND=${FIELDML-API_FOUND}")
...
if (OC_USE_IRON OR OC_DEPENDENCIES_ONLY)
	...
	message(STATUS " SOWING_FOUND=${SOWING_FOUND}")
        if(NOT SOWING_FOUND)
